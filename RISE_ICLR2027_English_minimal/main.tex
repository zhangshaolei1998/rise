...
\begin{itemize}[leftmargin=1em, itemsep=-1ex, topsep=0ex]
    ...
    \item \textbf{Strong Performance}: Experimental results on four tool-calling benchmarks show that \method surpasses Best-of-4 by up to 8.64 points on scenario goal completion under an identical rollout budget, and more importantly, its margin widens on the metrics that aggregate over correlated tasks.
\end{itemize}
...
\caption{Failed repair is common and harmful. The adjudicated label and the public signal both persist after Best-of-4 selection (a, b), and trajectories carrying the label complete far fewer tasks under either baseline (c, d).}
...
Best-of-4 & 72.13 & 46.67 & 4.1428 & 76.00 & 49.33 & 4.1893 & 78.00 & 50.67 & 4.2374 \\
...
\centering
\small
\caption{Results on AppWorld. `TGC' and `SGC' are task and scenario goal completion, and subscripts N and C are Test-Normal and Test-Challenge. \textbf{Bold} marks the best within each model.}
\label{tab:appworld}
\setlength{\tabcolsep}{3pt}
\begin{tabular}{lcccccccccccc}
\toprule
\multirow{2}{*}{Method} & \multicolumn{4}{c}{DeepSeek-v4.1-Flash} & \multicolumn{4}{c}{Qwen3.8-Max} & \multicolumn{4}{c}{GPT-5.6-Sol} \\
\cmidrule(lr){2-5}\cmidrule(lr){6-9}\cmidrule(l){10-13}
 & TGC$_{\mathrm{N}}$ & SGC$_{\mathrm{N}}$ & TGC$_{\mathrm{C}}$ & SGC$_{\mathrm{C}}$ & TGC$_{\mathrm{N}}$ & SGC$_{\mathrm{N}}$ & TGC$_{\mathrm{C}}$ & SGC$_{\mathrm{C}}$ & TGC$_{\mathrm{N}}$ & SGC$_{\mathrm{N}}$ & TGC$_{\mathrm{C}}$ & SGC$_{\mathrm{C}}$ \\
\midrule
Vanilla & 91.07 & 80.36 & 87.77 & 75.54 & 91.07 & 82.14 & 89.93 & 79.14 & 92.26 & 83.93 & 90.65 & 80.58 \\
Best-of-4 & 91.07 & 82.14 & 88.01 & 77.70 & 92.26 & 83.93 & 90.41 & 81.29 & 93.45 & 85.71 & 91.13 & 82.73 \\
...
Best-of-4 & 89.17 & 43.18 & 30.86 & 36.42 & 93.33 & 49.37 & 28.94 & 39.58 \\
...
Best-of-4 & 92.50 & 45.82 & 32.85 & 38.47 & 95.83 & 51.74 & 30.92 & 41.63 \\
...
Best-of-4 & 93.33 & 46.91 & 33.72 & 39.58 & 96.67 & 52.63 & 31.59 & 42.51 \\
...
\vspace{-14pt}
\centering
\includegraphics[width=\linewidth]{figures/rise_recovery_case.png}
\caption{Guidance localizes the defect to the dependent call that the baseline left unauthenticated.}
...
\vspace{-14pt}
\centering
\begin{minipage}[t]{0.48\linewidth}\vspace{0pt}\includegraphics[width=\linewidth]{figures/rise_frd_prevalence.png}\par\vspace{2pt}\centering\normalfont\scriptsize (a) Failed repair.\par\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}\vspace{0pt}\includegraphics[width=\linewidth]{figures/rise_rds_prevalence.png}\par\vspace{2pt}\centering\normalfont\scriptsize (b) Recovery risk.\par\end{minipage}
...
\caption{Gains concentrate on tasks that carry recovery risk. On fixed cohorts with an identical denominator, \method improves most where the targeted defect is present, whether the cohort comes from Vanilla or from Best-of-4.}
